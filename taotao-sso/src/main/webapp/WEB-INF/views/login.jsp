...
<%
    pageContext.setAttribute("staticBasePath", "http://static.taotao.com");
...
<head>
    ...
    <title>登录淘淘</title>
    <link type="text/css" rel="stylesheet" href="${staticBasePath}/css/login.css"/>
    <script type="text/javascript" src="${staticBasePath}/js/jquery-1.2.6.min.js"></script>
    <script type="text/javascript" src="${staticBasePath}/js/login/g.base.js"></script>
    <script type="text/javascript" src="${staticBasePath}/js/login/jdEdit.js"></script>
...
<div class="w">
    <div id="logo">
        <a href="http://www.taotao.com/" clstag="passport|keycount|login|01">
            <img src="${staticBasePath}/images/taotao-logo.gif" alt="淘淘" width="170" height="60"/>
        </a><b></b>
    </div>
</div>
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02"
                 style="width: 511px; height: 455px; position: absolute; left: -44px; top: -44px; background: url(${staticBasePath}/images/544a11d3Na5a3d566.png) 0px 0px no-repeat;">
            </div>
            <div class="form ">
                ...
                <div class="item fore3  hide " id="o-authcode">
                    ...
                    <div class="item-ifo">
                        <input type="text" id="authcode" class="text text-1" name="authcode" tabindex="6"
                ...
                <div class="item fore4 hide" id="autoentry">
                    <div class="item-ifo">
                        <input type="checkbox" class="checkbox" name="chkRememberMe"
                               clstag="passport|keycount|login|04"/>
                        ...
                        <div style="float:left;" id="ctrlDiv">
                            <input type="checkbox" class="checkbox" id="chkOpenCtrl" name="chkOpenCtrl"
                                   onclick="inputSelect();"/>
                            <label class="mar" id="jdsafe">安全控件登录
                                <div class="tip-safe" style="display:none;" id="tip-safe">安全控件可提高账户安全性，加密保护您的密码。</div>
                            </label>
                        </div>
                        <label><a href="http://safe.jd.com/findPwd/index.action" class=""
                                  clstag="passport|keycount|login|05">忘记密码?</a></label>
                        <div class="clr"></div>
                    </div>
                    <div class="updata" id="updata" style="display:none;">安全控件升级了!<a href="javascript:void(0);"
                                                                                     onclick="updateCtl()"
                                                                                     class="up-two"></a>立即更新</a> <a
                            class="up-one" href="javascript:void(0);" onclick="$('#updata').hide();"></a></div>
...
<script type="text/javascript" src="${staticBasePath}/js/login/login.js"></script>
<script type="text/javascript" src="${staticBasePath}/js/login/jdThickBox.js"></script>
<script type="text/javascript" src="${staticBasePath}/js/login/checkClient.js"></script>
<script>
