...
<script type="text/javascript" src="${staticBasePath}/js/jquery-extend.js"></script>
<script type="text/javascript" src="${staticBasePath}/js/lib-v1.js" charset="utf-8"></script>
<script type="text/javascript" src="${staticBasePath}/js/taotao.js" charset="utf-8"></script>
