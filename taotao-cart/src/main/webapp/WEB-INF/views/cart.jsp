...
<%
    request.setAttribute("staticBasePath", "http://static.taotao.com");
%>
...
<head>
    ...
    <link rel="stylesheet" href="${staticBasePath}/css/base.css">
    <link href="${staticBasePath}/css/purchase.2012.css?v=201410141639" rel="stylesheet" type="text/css">
...
<div class="w w1 header clearfix">
    <div id="logo"><a href="http://www.taotao.com/"><img clstag="clickcart|keycount|xincart|logo"
                                                         src="${staticBasePath}/images/taotao-logo.gif" title="返回淘淘商城首页"
                                                         alt="返回淘淘商城首页"></a></div>
...
<div class="w cart">
    <div class="cart-hd group">
        <h2>我的购物车</h2>
        <span id="show2" class="fore"> <span>现在&nbsp;</span><a class="btn" href="javascript:goToLogin();"><span
        ...
        <div class="cart-inner">
                    ...
                    <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
                        <div class="item_form clearfix">
                            ...
                            <div class="cell p-goods">
                                ...
                                <div class="p-name">
                                    <a href="http://www.taotao.com/item/${cart.itemId }.html"
            ...
            <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;">
              ...
              <span class="column t-checkbox form">
                  ...
                  <a href="http://www.taotao.com/" target="_blank" clstag="clickcart|keycount|xincart|coudanlink"
                     id="continue">继续购物</a>
              </span>
                    </div>
                  ...
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://www.taotao.com/order/create.html"
...
<script type="text/javascript" src="${staticBasePath}/js/base-v1.js"></script>
<!-- footer start -->
<jsp:include page="../commons/footer.jsp"/>
<!-- footer end -->

<!-- 购物车相关业务 -->
<script type="text/javascript" src="${staticBasePath}/js/cart.js"></script>
<script type="text/javascript" src="${staticBasePath}/js/jquery.price_format.2.0.min.js"></script>
