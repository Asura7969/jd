    ...
    a.fn.Jdropdown = function (b, c) {
        if (this.length) {
            ...
            var d = a.extend({
                ...
                current: "hover",
                delay: 0
            }, b || {}), e = "mouseover" == d.event ? "mouseout" : "mouseleave";
    ...
    a.fn.dropdown = function (b, c) {
        ...
        a.each(this, function () {
            function d() {
                ...
                var b = g.offset(), c = {x: b.left, y: b.top}, d = {x: b.left + g.outerWidth(), y: c.y}, e = {
                    x: b.left,
                    y: b.top + g.outerHeight()
                }, f = {x: b.left + g.outerWidth(), y: e.y};
    ...
    a.fn.Jtab = function (b, c) {
        if (this.length) {
            ...
            var d = a.extend({
                ...
                index: 0,
                compatible: !1
            }, b || {}), e = a(this).find("*[" + d.hookKey + "=" + d.hookItemVal + "]"), f = a(this).find("*[" + d.hookKey + "=" + d.hookContentVal + "]"), g = d.source.toLowerCase().match(/http:\/\/|\d|\.aspx|\.ascx|\.asp|\.php|\.html\.htm|.shtml|.js/g);
