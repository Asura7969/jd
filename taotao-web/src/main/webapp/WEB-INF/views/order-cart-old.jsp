		...
		<table class="order-table">
			...
			<c:forEach items="${carts }" var="cart">
				  <tr>
				    <td class="fore1">
					   <div class="p-goods">
						  <div class="p-img"><a href="http://www.taotao.com/item/${cart.itemId}.html"
                                    ...
                                    <div class="order-summary">
                                        ...
                                        <div class="statistic fr">
                                            <div class="list"><span><em id="span-skuNum">1</em> 件商品，总商品金额：</span><em
                                                    ...
                                                    v="<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${totalPrice/1000 }"/>">￥<fmt:formatNumber
                                                    groupingUsed="false" maxFractionDigits="2" minFractionDigits="2"
                                                    value="${totalPrice/1000 }"/></em></div>
                    ...
                    <div id="checkout-floatbar" class="checkout-buttons group">
                        <div class="inner">
                            ...
                            <span class="total">应付总额：<strong id="payPriceId">￥<fmt:formatNumber groupingUsed="false"
                                                                                                maxFractionDigits="2"
                                                                                                minFractionDigits="2"
                                                                                                value="${totalPrice/1000 }"/></strong>元
	    							</span>
